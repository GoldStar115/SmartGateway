...
- (void)viewDidLoad {
    ...
    [[dm apiEngine] feedbackCategoryOnCompletion:^(NSString *message, NSMutableArray *result) {
...
- (IBAction)typeClicked:(id)sender
{
    ...
    for(FeedbackCategory *cat in catArray)
    {
...
{
    [SVProgressHUD showWithMaskType:SVProgressHUDMaskTypeGradient];
    [[dm apiEngine] feedbackRegister:itemTextfield.text
